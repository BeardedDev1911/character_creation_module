...
def attack(char_name: str, char_class: str) -> str:
    """Принимает имя и класс персонажа. 
    Возвращает строку с результатом атаки противника.
    """
...
def defence(char_name, char_class):
    """Принимает имя и класс персонажа.
    Возвращает строку с результатом блока атаки противника.
    """
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Принимает имя и класс персонажа.
    Возвращает строку с результатом тренировки персонажа.
    """
    if char_class == 'warrior':
        print(
...
def choice_char_class() -> str:
    ...
    Запрашивает ввод до тех пор, пока игрок не подтвердит свой выбор.
    """
